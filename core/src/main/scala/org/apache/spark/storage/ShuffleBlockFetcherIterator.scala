...
final class ShuffleBlockFetcherIterator(
    ...
    blocksByAddress: Iterator[(BlockManagerId, scala.collection.IndexedSeq[(BlockId, Long, Int)])],
  ...
  private[this] def partitionBlocksByFetchMode(
      blocksByAddress:
        Iterator[(BlockManagerId, scala.collection.IndexedSeq[(BlockId, Long, Int)])],
      localBlocks: mutable.LinkedHashSet[(BlockId, Int)],
      hostLocalBlocksByExecutor:
        mutable.LinkedHashMap[BlockManagerId, scala.collection.IndexedSeq[(BlockId, Long, Int)]],
  ...
  private def createFetchRequest(
      blocks: scala.collection.IndexedSeq[FetchBlockInfo],
  ...
  private def createFetchRequests(
      curBlocks: scala.collection.IndexedSeq[FetchBlockInfo],
      address: BlockManagerId,
      isLast: Boolean,
  ...
  private def collectFetchRequests(
      address: BlockManagerId,
      blockInfos: scala.collection.Seq[(BlockId, Long, Int)],
  ...
  private def checkBlockSizes(blockInfos: scala.collection.Seq[(BlockId, Long, Int)]): Unit = {
  ...
  private def fetchMultipleHostLocalBlocks(
      bmIdToBlocks: Map[BlockManagerId, scala.collection.IndexedSeq[(BlockId, Long, Int)]],
  ...
  private[storage] def fallbackFetch(
      originalBlocksByAddr:
        Iterator[(BlockManagerId, scala.collection.IndexedSeq[(BlockId, Long, Int)])]): Unit = {
...
object ShuffleBlockFetcherIterator {
  ...
  def mergeContinuousShuffleBlockIdsIfNeeded(
      blocks: scala.collection.IndexedSeq[FetchBlockInfo],
      doBatchFetch: Boolean): scala.collection.IndexedSeq[FetchBlockInfo] = {
