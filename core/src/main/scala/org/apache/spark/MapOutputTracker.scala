...
private[spark] case class MapSizesByExecutorId(
  iter: Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])], enableBatchFetch: Boolean)
...
private[spark] abstract class MapOutputTracker(conf: SparkConf) extends Logging {
  ...
  def getMapSizesByExecutorId(shuffleId: Int, reduceId: Int)
      : Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])] = {
  ...
  def getMapSizesByExecutorId(
      ...
      endMapIndex: Int,
      startPartition: Int,
      endPartition: Int): Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])]
  ...
  def getMapSizesForMergeResult(
      shuffleId: Int,
      partitionId: Int): Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])]
  ...
  def getMapSizesForMergeResult(
      shuffleId: Int,
      partitionId: Int,
      chunkBitmap: RoaringBitmap): Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])]
...
private[spark] class MapOutputTrackerMaster(
  ...
  override def getMapSizesForMergeResult(
      shuffleId: Int,
      partitionId: Int,
      chunkTracker: RoaringBitmap): Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])] = {
    Seq.empty.iterator
  }
...
private[spark] object MapOutputTracker extends Logging {
  ...
  def convertMapStatuses(
    ...
    MapSizesByExecutorId(splitsByAddress.mapValues(_.toIndexedSeq).iterator, enableBatchFetch)
  }
  ...
  def getMapStatusesForMergeStatus(
      ...
      partitionId: Int,
      mapStatuses: Array[MapStatus],
      tracker: RoaringBitmap): Iterator[(BlockManagerId, IndexedSeq[(BlockId, Long, Int)])] = {
    ...
    splitsByAddress.mapValues(_.toIndexedSeq).iterator
  }
